...
__DEFINE__(1672048273146, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1672048273147,"./event-store":1672048273148}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1672048273147, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1672048273148, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1672048273147,"./utils":1672048273149}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1672048273149, function(require, module, exports) {
...
return __REQUIRE__(1672048273146);
})()
